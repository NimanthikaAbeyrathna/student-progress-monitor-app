...
})({"epZ2E":[function(require,module,exports) {
...
const eyeElm = (0, _jqueryDefault.default)("#eye");
const passwordOuter = (0, _jqueryDefault.default)(".form-floating icons");
const nameElm = (0, _jqueryDefault.default)("#name");
const userNameElm = (0, _jqueryDefault.default)(".userName");
const passwordElm = (0, _jqueryDefault.default)("#passwordElement");
const btnSignUp = (0, _jqueryDefault.default)("#signUp");
const outerFullName = (0, _jqueryDefault.default)("#fullNameInput");
const outerUserName = (0, _jqueryDefault.default)("#userNameInput");
...
function validation() {
    ...
    if (!fullName) validate = regEx(nameElm, outerFullName, "Name can not be empty");
    else if (!/^[A-Za-z ]+$/.test(fullName)) validate = regEx(nameElm, outerFullName, "Name includes only letters");
    if (!userName) validate = regEx(userNameElm, outerUserName, "User name can not be empty");
    else if (!/^[A-Za-z0-9 ]+$/.test(userName)) validate = regEx(userNameElm, outerUserName, "User Name contain only letters and numbers");
    if (!password) validate = regEx(passwordElm, outerPassword, "Password can not be empty");
    else if (!/.{5,}/.test(password)) validate = regEx(passwordElm, outerPassword, "Password length is not enough");
    return validate;
}
