...
var _reportDesignJs = require("./report-design.js");
const yearInput = (0, _jqueryDefault.default)("#yearInput");
const btnYear = (0, _jqueryDefault.default)("#btnYearSave");
const semesterInput = (0, _jqueryDefault.default)("#semesterInput");
const btnSemester = (0, _jqueryDefault.default)("#btnSemesterSave");
const gradeInput = (0, _jqueryDefault.default)("#gradeInput");
const btnGrade = (0, _jqueryDefault.default)("#btnGradeSave");
const classCodeInput = (0, _jqueryDefault.default)("#classCodeInput");
const btnClass = (0, _jqueryDefault.default)("#btnClassSave");
const subjectNameInput = (0, _jqueryDefault.default)("#subjectNameInput");
const btnSubject = (0, _jqueryDefault.default)("#btnSubjectSave");
const printButton = (0, _jqueryDefault.default)("#printButton");
const studentIdInputInPrint = (0, _jqueryDefault.default)("#studentIdInput");
const classInputInPrint = (0, _jqueryDefault.default)("#classInput");
const yearInput2InPrint = (0, _jqueryDefault.default)("#yearInput2");
const semesterInputFieldInPrint = (0, _jqueryDefault.default)("#semesterInputField");
const gradeInputFieldInPrint = (0, _jqueryDefault.default)("#gradeInputField");
btnYear.on("click", ()=>{
    ...
    xhr.addEventListener("readystatechange", function() {
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                billWindow.document.write((0, _reportDesignJs.getReportDesignHTML)(responseObject));
            } else {
                const errorObj = JSON.parse(xhr.responseText);
    ...
    xhr.addEventListener("readystatechange", ()=>{
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                if (!classList.length) classInputInPrint.append(`<option>Please enter classes to show</option>`);
            } else {
                classInputInPrint.empty();
    ...
    xhr.addEventListener("readystatechange", ()=>{
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                if (!yearList.length) yearInput2InPrint.append(`<option>Please enter years to show</option>`);
            } else {
                yearInput2InPrint.empty();
    ...
    xhr.addEventListener("readystatechange", ()=>{
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                if (!semesterList.length) semesterInputFieldInPrint.append(`<option>Please enter semesters to show</option>`);
            } else {
                semesterInputFieldInPrint.empty();
    ...
    xhr.addEventListener("readystatechange", ()=>{
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                if (!gradeList.length) gradeInputFieldInPrint.append(`<option>Please enter grades to show</option>`);
            } else {
                gradeInputFieldInPrint.empty();
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./report-design.js":"88YyZ"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"88YyZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getReportDesignHTML", ()=>getReportDesignHTML);
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
function getReportDesignHTML(responseObject) {
    const studentMarkList = responseObject[0];
    const student = responseObject[1];
    const studentTotalMarkList = responseObject[2];
    let sumOfMarks = 0;
    for(let i = 0; i < studentMarkList.length; i++)sumOfMarks += studentMarkList[i].mark;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","jquery":"hgMhh"}]},["gEwwu","1SICI"], "1SICI", "parcelRequire8d29")
